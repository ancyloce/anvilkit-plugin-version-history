...
> **Alpha (`0.1.3`).** Header actions and the diff/apply engine are stable. The sidebar-panel slot contribution is deferred until `StudioPluginContext` exposes the sidebar registration API.
